...
rigid_particle_wall = pm.RigidParticles(
    positions=rigid_pos,
    velocities=rigid_velocities,
    shapefunction=pm.LinearShapeFunction.create(len(rigid_pos), 2)
...
pm.plot_simple_3D(
    ...
    points_data_rigid_dict=points_data_rigid_dict,
