...
class LinearElasticLaw(ConstitutiveLaw):
    ...
    def _update_stress(
        ...
        return stress_prev + self.lam * jnp.trace(deps) * jnp.eye(3) + 2.0 * self.G * deps
    ...
    def get_dt_crit(self: Self, material_points_state:MaterialPointState, cell_size: float, alpha: float = 0.5) -> Float[Array, ""]:
        """
