...
def update_from_params(
    ...
    stress, material = material.update_stress_benchmark(strain_rates, next_volumes, dt)
    return stress, strain_trail, material, next_volumes


def triax_loss(strain_guess_11_22, confine_11_22, target_strain_tensor, strain_prev, dt, material, volumes):
    stress, _, material, _ = update_from_params(
        material, strain_guess_11_22, target_strain_tensor, strain_prev, volumes, dt
    )
...
def triaxial_compression(
    ...
    def body_loop(step, carry):
        ...
        params, opt_state = jax.lax.fori_loop(0, num_opt_iter, run_solver_, (params, opt_state))

        stress, strain, material, volumes = update_from_params(
            material, params, target_strain_tensor, strain_prev, volumes, dt
        )
