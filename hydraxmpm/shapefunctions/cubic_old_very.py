...
class CubicShapeFunction2(ShapeFunction):
    ...
    def create(cls: Self, num_particles: jax.numpy.int32, dim: jax.numpy.int16) -> Self:
        ...
        # )
        # node_type_stack = (
        #     jnp.zeros(nodes.num_nodes_total).reshape(nodes.grid_size).astype(jnp.int32)
        # )
        # if dim ==2:
        #     # boundary layers
        #     node_type_stack = node_type_stack.at[0, :].set() #x0
        #     node_type_stack = node_type_stack.at[:, 0].set() #y0
        #     node_type_stack = node_type_stack.at[nodes.grid_size[0]-1, :].set() #x1
        #     node_type_stack = node_type_stack.at[:, nodes.grid_size[1] -1].set() #y0
