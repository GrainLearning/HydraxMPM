...
class RigidParticles:
    ...
    def apply_on_nodes_moments(
        ...
        nr_intr_normal = vmap_nrp2g_grid_normals(
        ...
        r_shapefunctions = self.shapefunction.calculate_shapefunction(
        ...
        r_scaled_velocity = vmap_rp2g_velocities(
            r_shapefunctions.intr_ids,
            r_shapefunctions.intr_shapef
        )
        ...
        def vmap_nodes(
            ...
            new_nodes_vel_nt = jax.lax.cond(
                ( (r_nodes_contact_mask)&(criteria > 0.)),
